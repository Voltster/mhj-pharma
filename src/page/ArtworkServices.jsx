...
const ArtworkServices = () => {
  return (
    <div className="min-h-screen relative w-full mx-auto pt-1">
      ...
      />
      {/* <h4 className="text-2xl md:text-4xl font-semibold w-10/12 mx-auto text-center text-[#B51915] ">
        Streamlining the Process
      </h4>
      <p className="w-11/12 md:w-8/12 mt-2 mx-auto text-center">
        Our regulatory artwork management services are designed to enhance the
        efficiency of the process, saving you time and resources. We take care
        of every aspect of the artwork management process, from design and
