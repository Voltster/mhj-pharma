...
import Imvast20 from "../../assets/ProductInfo/Imvast20.png";


const porductInfo = [
  {
    productName: "SIMVASTATIN TABlets USP 20 mg",
    brand: "imvast 20",
    price: null,
    batchCode: "MET25001",
    ...
    expiryOn: "Dec 2027",
    genuineProduct: true,
    productImage: Imvast20,
    labelImage: Imvast20,
    description: {
      genericName: "Simvastatin Tablets USP 20 mg",
    ...
    <section className='w-full'>
       {
        porductInfo.map((info,i)=>(
          ...
          <tbody>
            ...
            <div className='uppercase whitespace-pre'>
...
export default PackshotInfoPage