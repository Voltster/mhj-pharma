  ...
  return (
    <section className="min-h-screen relative w-full mx-auto ">
      <div className="py-20 h-screen  relative">
        ...
        <div className="relative overflow-x-auto  sm:rounded-lg overflow-y-scroll h-[80%] w-11/12 mx-auto ">
          <table className="w-full  mx-auto text-sm text-left rtl:text-right text-gray-500  h-[80%] productBg overflow-auto">
