...
const Error404 = () => {
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 z-[99] fixed heroBg  top-0 px-2 bg-white">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center ">
        <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-[#B61A15]">
          404
        </p>
        <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-[#B61A15] mt-2 ">
          Page Not Found
        </p>
        <p className="text-lg md:text-xl lg:text-2xl text-gray-700 my-12">
          Sorry, the page you are looking for could not be found.
        </p>
        <Link
          to="/"
          className=" text-white  uppercase py-2 px-6 xl:py-3 xl:px-8 transition-all duration-500 rounded-[30px] focus:outline-none primaryButton bg-transparent hover:shadow-lg text-nowrap text-base  hover:scale-[1.02] active:scale-[0.9] flex  justify-center items-center"
          title="Return Home"
        >
          <svg
