...
const images = [
  ...
  { img: uzbek, name: "MOH, Uzbek" },
  { img: tazkistan, name: "MOH, Tazkistan" },
...
const InfinityScroll = () => {
  return (
    <div className="my-24">
      <h2 className="text-xl text-nowrap xl:text-4xl text-gray-900 uppercase py-2 text-center w-[70%] mx-auto font-semibold">
        Clearance & Approval
      </h2>
          ...
          {images.map((e, i) => (
            <div key={i} className="my-8">
              <img
                src={e.img}
                alt={e.img}
                className="w-[auto] h-[9vh] md:h-[15vh] mix-blend-multiply py-2"
              />
              <p className="text-base text-center text-gray-800">{e.name}</p>
            </div>
          ))}
        </div>
      </div>
