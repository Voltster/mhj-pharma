  ...
  return (
    <div className="main w-screen h-[90vh] fixed z-50 bg-white flex justify-center items-center">
      <div className="loaderPil text-center">
        <div className="loaderAnim h-[160px] relative -z-10 mb-2">
          <div className="loader-anime-bounce">
            <div className="loaderPill-anim-flop">
              <div className="loaderPill-Pill inline-block box-border w-[80px] h-[30px] border border-[#941616] rounded-[15px] overflow-hidden">
                <div className="bg-[#941616] h-full w-1/2"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <h2 className="uppercase text-xl md:text-2xl font-bold bg-gradient-to-r from-[#941616] via-[#db3700] to-[#fe5628] text-transparent bg-clip-text">
