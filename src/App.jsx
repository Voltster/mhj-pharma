...
const OncologyModal = lazy(() => import("./components/oncology/OncologyModal"));
            ...
            <Routes>
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        " Export Oriented Pharmaceutical Solutions | MHJ Pharmaconcepts"
                      }
                      description={
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        "Expert Team in Pharmaceuticals | MHJ Pharmaconcepts"
                      }
                      description={
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        "About us - Innovative Differentiated Formulations"
                      }
                      description={
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        "Product - Global Pharmaceutical Solutions for Better Health"
                      }
                      description={
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        " Clinical Regulatory Affairs | MHJ Pharmaconcepts Pvt Ltd"
                      }
                      description={
                        " MHJ Pharmaconcepts offers comprehensive clinical regulatory affairs services to guide your pharmaceutical products through global regulatory pathways with expertise and precision"
                      }
                      keywords={
                        "Clinical Regulatory Affairs, Global Regulatory Compliance, Clinical Trial Regulatory Services, Regulatory Affairs Consulting, Pharmaceutical Regulatory Services"
                      }
                    />{" "}
                    <ClinicalServices />
                  </>
              ...
              <Route
                ...
                element={
                  <>
                    ...
                    <SEO
                      title={
                        " Pharmacovigilance Services for Drug Safety | MHJ Pharmaconcepts"
                      }
                      description={
                        " MHJ Pharmaconcepts provides comprehensive pharmacovigilance services to ensure drug safety, monitor adverse effects, and maintain regulatory compliance globally"
                      }
                      keywords={
                        " Pharmacovigilance Services, Drug Safety Monitoring, Adverse Event Reporting, Pharmacovigilance Compliance, Global Drug Safety Solutions"
                      }
                    />{" "}
                    <Pharmacovigilance />
                  </>
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={" Oncology - Innovative Cancer Care Solutions"}
                      description={
                        "MHJ Pharmaconcepts leads the way in innovative cancer care solutions, offering high-quality oncology products for better patient care worldwide"
                      }
                      keywords={
                        " Oncology Generics Manufacturer, Biosimilars for Cancer Treatment, Advanced Oncology Formulations, Targeted Cancer Therapies, Affordable Cancer Care Solutions"
                      }
                    />{" "}
                    <Oncology />{" "}
                  </>
              ...
              <Route
                ...
                element={
                  <>
                    ...
                    <SEO
                      title={
                        "Oncology Injectables Solutions | MHJ Pharmaconcepts Pvt Ltd"
                      }
                      description={
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        "Oral Solid Capsules for Effective Treatment | MHJ Pharmaconcepts"
                      }
                      description={
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={"Oncology Oral Solid Tablets | MHJ Pharmaconcepts"}
                      description={
                        "Explore MHJ Pharmaconcepts range of high-quality oncology oral solid tablets, offering safe and effective treatment options for various therapeutic areas in global markets"
                      }
                      keywords={
                        "Oncology Oral Solid Tablets, Cancer Treatment Tablets, Pharmaceutical Oncology Tablets, Oral Solid Dosage Oncology, Oncology Tablets for Healthcare"
                      }
                    />
                    <OncoProductList
                      data={tabletData}
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        " Innovative Injectable Medicines | MHJ Pharmaconcepts"
                      }
                      description={
                        " MHJ Pharmaconcepts specializes in injectable pharmaceuticals, delivering innovative healthcare solutions with a focus on quality and compliance"
                      }
                      keywords={
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        "Oral Solid Tablets for Healthcare | MHJ Pharmaconcepts"
                      }
                      description={
                        " MHJ Pharmaconcepts specializes in manufacturing oral solid tablets, ensuring high-quality standards and innovative solutions for global healthcare markets"
                      }
                      keywords={
                        "General Oral Solid Tablets, Pharmaceutical Oral Tablets, Oral Tablets for Healthcare Solid Dosage Tablets, High-Quality Oral Tablets"
                      }
                    />
                    <ProductLists
                      data={tablets}
              ...
              <Route
                ...
                element={
                  <>
                    ...
                    <SEO
                      title={
                        "Oral Solid Capsules for Healthcare | MHJ Pharmaconcepts"
                      }
                      description={
                        "Explore MHJ Pharmaconcepts' portfolio of oral solid capsules, developed to meet rigorous quality standards and provide effective treatment options globally"
                      }
                      keywords={
                        "General Oral Solid Capsules, Pharmaceutical Oral Capsules, Oral Capsules for Healthcare, Capsule Dosage Forms, High-Quality Oral Capsules"
                      }
                    />{" "}
                    <ProductLists
                      data={capsules}
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        "Reliable General Oral Liquids for Healthcare | MHJ Pharmaconcepts"
                      }
                      description={
                        "Discover MHJ Pharmaconcepts' portfolio of general oral liquid products, designed to meet global healthcare needs with a focus on safety and efficacy"
                      }
                      keywords={
                        "General Oral Liquid Products, Pharmaceutical Oral Liquids, Oral Liquid Dosage Forms, High-Quality Oral Liquids, Liquid Pharmaceutical Solutions"
                      }
                    />{" "}
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        " Infusion Solutions for Healthcare | MHJ Pharmaconcepts"
                      }
                      description={
                        "Explore MHJ Pharmaconcepts' portfolio of advanced infusion products, providing safe, effective, and reliable solutions for a wide range of medical treatments globally"
                      }
                      keywords={
                        "Infusion Products, Pharmaceutical Infusions, Infusion Solutions, IV Infusions, Infusion Therapy"
                      }
                    />{" "}
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        " Nutraceutical Supplements for Global Wellness | MHJ Pharmaconcepts"
                      }
                      description={
                        "MHJ Pharmaconcepts offers a diverse range of nutraceutical supplements, designed to improve health outcomes and wellness with advanced formulations and premium quality"
                      }
                      keywords={
                        "Nutraceutical Products, Health Supplements, Nutraceuticals for Wellness Pharmaceutical Nutraceuticals, Nutraceutical Solutions"
                      }
                    />{" "}
                    <ProductLists data={otc} heading={"nutraceutical"} />{" "}
                  </>
                }
              />
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={"R&D - Advanced Pharma Solutions"}
                      description={
                        "At MHJ Pharmaconcepts, our R&D efforts drive the future of healthcare with innovative products, including generics, biosimilars, and advanced formulations for better patient care"
                      }
                      keywords={
                        "Pharmaceutical Research and Development, Innovative Drug Development R&D in Biosimilars, Pharmaceutical R&D Solutions, Advanced Drug Delivery Systems R&D"
                      }
                    />{" "}
                    <Research />
                  </>
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={"Global Pharma Solutions by MHJ Pharmaconcepts"}
                      description={
                        " At MHJ Pharmaconcepts, our innovative manufacturing units produce top-tier pharmaceutical products, ensuring quality, compliance, and advanced drug formulations worldwide"
                      }
                      keywords={
                        " Pharmaceutical Manufacturing Units, Advanced Drug Manufacturing Facilities Quality Pharmaceutical Manufacturing, Global Pharmaceutical Manufacturing Solutions"
                      }
                    />{" "}
                    <Manufacture />
                  </>
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={
                        "Quality Control - Ensuring Pharmaceutical Beats Benchmarks"
                      }
                      description={
                        " MHJ Pharmaconcepts follows rigorous quality control procedures for all our pharmaceutical products, ensuring the highest level of quality and patient safety globally"
                      }
                      keywords={
                        "Pharmaceutical Quality Control, Quality Assurance in Pharma, Global Pharma Quality Standards, Rigorous Quality Control Processes, Compliance in Pharmaceutical Manufacturing"
                      }
                    />{" "}
                    <QualityControls />
                  </>
              ...
              />
              <Route
                path="/globalfootprint"
                element={
                  <>
                    <SEO
                      title={
                        " Global Footprint - Delivering Healthcare Worldwide"
                      }
                      description={
                        " Explore MHJ Pharmaconcepts' global footprint, providing innovative pharmaceutical solutions across major international markets with a commitment to improving global health"
                      }
                      keywords={
                        "Global Pharmaceutical Reach, MHJ Pharmaconcepts Worldwide International Healthcare Solutions, Pharmaceutical Global Footprint,  Global Pharmaceutical Presence"
                      }
                    />{" "}
                    <GlobalPresence />
                  </>
              ...
              <Route
                ...
                element={
                  <>
                    <SEO
                      title={"Contact Us - MHJ Pharmaconcepts"}
                      description={
                        " Connect with MHJ Pharmaconcepts for pharmaceutical inquiries, product support, or to explore potential partnerships. We're ready to help!"
                      }
                      keywords={
                        "Contact Pharmaceutical Company, Pharmaceutical Customer Support, Contact MHJ Pharmaconcepts, Contact for Pharma Inquiries, Pharmaceutical Partnership Inquiries"
                      }
                    />{" "}
                    <Contact />
                  </>
